...
// 		bufferHelper.concat(buf)
// 		arr.push(buf)
// 		length+=buf.length;
// 	})
// 	res.on('end',function () {
// 		var data=Buffer.concat(arr,length);
// 		// console.log(iconv.decode(data,'gb18030').toString())
...
//
// 	await page.goto('https://trade.500.com/jczq/?playid=270&g=2&date='+moment().format('YYYY-MM-DD'));
//
